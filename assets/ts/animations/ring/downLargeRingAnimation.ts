import { RingSetting, DownLargeRingSettings } from "./ring.config";
import { CalculateCurrentSetting } from "../globalAnimationSetting.config";

export const downLargeRingAnimation = (id: string) => {
...
function update(element: HTMLElement) {
  const setting: RingSetting = CalculateCurrentSetting(DownLargeRingSettings);
