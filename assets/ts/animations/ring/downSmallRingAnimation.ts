import { RingSetting, DownSmallRingSettings } from "./ring.config";
import { CalculateCurrentSetting } from "../globalAnimationSetting.config";

export const downSmallRingAnimation = (id: string) => {
...
function update(element: HTMLElement) {
  const setting: RingSetting = CalculateCurrentSetting(DownSmallRingSettings);
